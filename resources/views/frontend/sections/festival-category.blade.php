  ...
  <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
      ...
      >
        ...
        <a
          href="./categories/competitions.html"
      ...
      >
        ...
        <a
          href="./categories/community.html"
