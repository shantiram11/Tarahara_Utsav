<section>
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div
            class="mt-12 rounded-3xl border border-slate-200 bg-white/60 p-6 backdrop-blur"
          >
            <p
              class="mb-6 text-center text-xs font-semibold uppercase tracking-[0.2em] text-slate-500"
            >
              Tier 1
            </p>
            <div class="grid grid-cols-2 items-stretch gap-3
             sm:grid-cols-4">
              ...
              >
                <img
                  class="h-12 opacity-80 transition-all group-hover:opacity-100"
          ...
          <div
            class="mt-10 rounded-3xl border border-slate-200 bg-white/60 p-6 backdrop-blur"
          >
            <p
              class="mb-6 text-center text-xs font-semibold uppercase tracking-[0.2em] text-slate-500"
            >
            ...
            <div class="grid grid-cols-2 items-stretch gap-2 sm:grid-cols-6">
              ...
              >
                <img
                  class="h-10 opacity-70 transition-all group-hover:opacity-100"
                  src="{{ asset('assets/Logo.png') }}"
                  alt="Figma"
                />
              </a>
