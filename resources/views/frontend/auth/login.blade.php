...
<div class="min-h-screen bg-gradient-to-br from-yellow-50 via-orange-50 to-red-50 flex items-center justify-center p-4 relative overflow-hidden">
    ...
    <div class="relative z-10 w-full max-w-sm sm:max-w-md px-4 sm:px-0">
        ...
        <div class="text-center mb-6 sm:mb-8 mt-16 sm:mt-0">
            <h1 class="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-800 mb-2">Welcome Back!</h1>
            <p class="text-sm sm:text-base text-gray-600">Sign in to your Tarahara Utsav account</p>
        </div>
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-4 sm:space-y-6">
                ...
                <div class="space-y-1 sm:space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <input id="password" name="password" type="password" required
                               class="w-full pl-10 sm:pl-12 pr-10 sm:pr-12 py-3 sm:py-4 bg-gray-50/80 border {{ $errors->has('password') ? 'border-red-500' : 'border-gray-200' }} rounded-xl sm:rounded-2xl focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all duration-300 placeholder-gray-400 text-sm sm:text-base"
                               placeholder="Enter your password">
                        <button type="button" onclick="togglePassword('password')" class="absolute inset-y-0 right-0 pr-3 sm:pr-4 flex items-center touch-manipulation">
                            <svg id="eye-password" class="h-4 w-4 sm:h-5 sm:w-5 text-gray-400 hover:text-gray-600 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path>
                            </svg>
                            <svg id="eye-off-password" class="h-4 w-4 sm:h-5 sm:w-5 text-gray-400 hover:text-gray-600 transition-colors hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
                    <div class="flex items-center">
                        <input id="remember-me" name="remember-me" type="checkbox"
                               class="h-4 w-4 text-red-600 focus:ring-red-500 border-gray-300 rounded touch-manipulation">
                        <label for="remember-me" class="ml-2 block text-xs sm:text-sm text-gray-700">Remember me</label>
                    </div>
                    <a href="{{ route('password.request') }}" class="text-xs sm:text-sm text-red-600 hover:text-red-500 font-medium transition-colors">
                        Forgot password?
                    </a>
                </div>
                ...
                <div class="relative">
                    ...
                    <div class="relative flex justify-center text-xs sm:text-sm">
                        <span class="px-3 sm:px-4 bg-white text-gray-500">Or continue with</span>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-3 gap-2 sm:gap-3">
                    <button type="button"
                            class="flex justify-center items-center py-2.5 sm:py-3 px-2 sm:px-4 bg-white border border-gray-200 rounded-lg sm:rounded-xl shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-0.5 group touch-manipulation">
                        <svg class="w-4 h-4 sm:w-5 sm:h-5 group-hover:scale-110 transition-transform" viewBox="0 0 24 24">
                    ...
                    <button type="button"
                            class="flex justify-center items-center py-2.5 sm:py-3 px-2 sm:px-4 bg-white border border-gray-200 rounded-lg sm:rounded-xl shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-0.5 group touch-manipulation">
                        <svg class="w-4 h-4 sm:w-5 sm:h-5 group-hover:scale-110 transition-transform" viewBox="0 0 24 24" fill="#000">
                    ...
                    <button type="button"
                            class="flex justify-center items-center py-2.5 sm:py-3 px-2 sm:px-4 bg-white border border-gray-200 rounded-lg sm:rounded-xl shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-0.5 group touch-manipulation">
                        <svg class="w-4 h-4 sm:w-5 sm:h-5 group-hover:scale-110 transition-transform" viewBox="0 0 24 24" fill="#1877f2">
                ...
                <div class="text-center">
                    <p class="text-xs sm:text-sm text-gray-600">
                        ...
                        <a href="{{ route('register') }}" class="text-red-600 hover:text-red-500 font-semibold transition-colors">
                            Sign up now
                        </a>
                    </p>
                </div>
