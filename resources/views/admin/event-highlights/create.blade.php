...
@section('page_title', 'Create Event Highlight')

@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h2 class="mb-4">Create Event Highlight</h2>
            ...
            <div class="card-body">
                <form action="{{ route('admin.event-highlights.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="date" name="date" value="{{ old('date') }}" placeholder="e.g., December 15, 2025" required>
                    </div>

                    <div class="mb-3">
                        <label for="icon" class="form-label">Icon <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="icon" name="icon" value="{{ old('icon') }}" placeholder="e.g., ⭐, 🚩, 👨‍🍳" required>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="color_scheme" name="color_scheme" required>
                            ...
                            <option value="purple" {{ old('color_scheme') == 'purple' ? 'selected' : '' }}>Purple</option>
                            <option value="orange" {{ old('color_scheme') == 'orange' ? 'selected' : '' }}>Orange</option>
                    ...
                    <div class="d-flex gap-2">
                        <button type="submit" class="btn btn-primary">Create Event Highlight</button>
