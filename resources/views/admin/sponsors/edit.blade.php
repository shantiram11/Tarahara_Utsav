...
<div class="row justify-content-center">
    <div class="col-lg-8">
        <div class="card">
            <div class="card-body">
                <form id="sponsorForm" action="{{ route('admin.sponsors.update', $sponsor->id) }}" method="POST" enctype="multipart/form-data" novalidate>
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('title') is-invalid @enderror"
                               id="title" name="title" value="{{ old('title', $sponsor->title) }}"
                    ...
                    <div class="mb-3">
                        ...
                        <select id="tier" name="tier" class="form-select @error('tier') is-invalid @enderror" required>
                            ...
                            <option value="tier1" {{ old('tier', $sponsor->tier) == 'tier1' ? 'selected' : '' }}>
                                Tier 1 - Premium (Larger display, prominent placement)
                            </option>
                            <option value="tier2" {{ old('tier', $sponsor->tier) == 'tier2' ? 'selected' : '' }}>
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('amount') is-invalid @enderror" id="amount" name="amount" value="{{ old('amount', $sponsor->amount) }}" placeholder="RS. 2,00,000/-">
                            <div id="amountError" class="invalid-feedback"></div>
                        </div>
                        <div class="col-md-6">
                            <label for="label" class="form-label">Label (e.g., TITLE SPONSOR)</label>
                            <input type="text" class="form-control @error('label') is-invalid @enderror" id="label" name="label" value="{{ old('label', $sponsor->label) }}" placeholder="TITLE SPONSOR">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                <p class="text-muted mb-1">Current sponsor logo</p>
                    ...
                    <!-- New Image Upload -->
                    <div class="mb-3">
                        <label for="image" class="form-label">New Sponsor Logo/Image</label>
                        ...
                        <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-primary transition-colors duration-200"
                            ...
                            <div id="uploadContent">
                                ...
                                <p class="text-muted small">PNG, JPG, JPEG, WEBP up to 2MB (optional for updates)</p>
                            </div>
                        ...
                        <div class="d-flex gap-4">
                            <div class="form-check">
                                <input type="radio" class="form-check-input" name="is_active" value="1"
                                       id="active" {{ $sponsor->is_active ? 'checked' : '' }}>
                                <label class="form-check-label" for="active">Active</label>
                            </div>
                            <div class="form-check">
                                <input type="radio" class="form-check-input" name="is_active" value="0"
                                       id="inactive" {{ !$sponsor->is_active ? 'checked' : '' }}>
